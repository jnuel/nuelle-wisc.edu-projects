...
signAcademicHonestyPolicy('Joy Nuelle', 'nuelle');
...
portrait_pts = [1 1; 326 1; 326 399; 1 399];
bg_pts = [102 21; 276 73; 284 423; 84 439];
...
ransac_eps = 15; % Acceptable alignment error 
...
% stitch three images
imgc = im2single(imread('myimg_center.jpg'));
imgl = im2single(imread('myimg_left.jpg'));
imgr = im2single(imread('myimg_right.jpg'));
